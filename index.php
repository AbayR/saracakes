...
<style>
    ...
    <li class="nav-item"><a class="nav-link js-scroll-trigger" href="#gallery">Gallery</a></li>
        <li class="nav-item"><a class="nav-link" href="#reservationModal"
                            data-toggle="modal">Order</a></li>
                    <li class="nav-item"><a class="nav-link js-scroll-trigger" href="#contact">Contact</a></li>
                    <li class="nav-item"><a class="nav-link" href="logas.php">Login</a></li>
                    <li class="nav-item"><a class="nav-link" href="regis.php">Register</a></li>
                </ul>
            </div>
        </div>
    </nav>
...
@media screen and (max-width:600px){
    ...
    .inner-container{
        ...
        <div class="inner-container">
            <h1>About us</h1>
            <p class="text">
                 This is text about us and something really useful so bla bla bla
            </p>
        </div>
    </div>
    </section>
      ...
      <div class="inner-width">
        ...
        <div class="services-container">
          ...
          <div class="service-box">
            ...
            <div class="service-desc">
             Products are great and free and cool
            </div>
          </div>
          ...
          <div class="service-box">
            ...
            <div class="service-desc">
             Every client is fullfilled with love 
            </div>
          </div>
          ...
          <div class="service-box">
            ...
            <div class="service-desc">
              Price is awesome nowhere else u could find it
            </div>
          </div>
  ...
  .gallery-section .image{
    flex: 100%;
      ...
      <div class="col-lg-12 text-center">
                    <h2 class="text-uppercase section-heading">Gallery</h2> <!--gallery-->
                </div>
        <div class="border"></div>
        <div class="gallery">
...
@media screen and (max-width:600px) {
  .pe{
    ...
    <div class="inner-width">
      <h1>Our team</h1>  <!--out team-->
      <div class="pers">


        <div class="pe">
          <img src="assets/img/team/person1.jpg" alt="">
          <div class="p-name">Somebody somebody </div>
          <div class="p-des">Designer</div>
          <div class="p-sm">
            <a href="https://www.instagram.com/sara_razakova76/"><i class="fab fa-facebook-f"></i></a>
            <a href="https://www.instagram.com/sara_razakova76/"><i class="fab fa-twitter"></i></a>
            <a href="https://www.instagram.com/sara_razakova76/"><i class="fab fa-instagram"></i></a>
          </div>
        </div>

        <div class="pe">
          <img src="assets/img/team/person2.jpg" alt="">
          <div class="p-name">Somebody social</div>
          <div class="p-des">Delivery guy</div>
          <div class="p-sm">
            <a href="https://www.instagram.com/sara_razakova76/"><i class="fab fa-facebook-f"></i></a>
            <a href="https://www.instagram.com/sara_razakova76/"><i class="fab fa-twitter"></i></a>
            <a href="https://www.instagram.com/sara_razakova76/"><i class="fab fa-instagram"></i></a>
        ...
        <div class="pe">
          ...
          <div class="p-name">Somebody someAction</div>
             ...
             <div class="row">
                <div class="col-lg-12">
                 ...
                 <textarea name="text_message" class="form-control mb-2" placeholder="Text"></textarea>
                                ...
                                <input class="btn btn-primary btn-xl text-uppercase" type="submit" name="message" value="Send" />
